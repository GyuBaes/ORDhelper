...
- 초불영제 유닛 alt 좌클릭시 삭제 (악몽밴)
  ㄴ퍼센트 버그 있는데 초불영제라 상관없는거같고 수치에는 영향주지않습니다 (크제 밴이면 비영도 자동밴이라 상관X)
...
겨우 spa을 만드는데 꽤 많은 시간을 쏟았다 진짜 조금 더 나은 방향으로 수정할 부분이 계속 나왔다
무슨 과제최종본*최종최종*최종진짜최종본 이런느낌
